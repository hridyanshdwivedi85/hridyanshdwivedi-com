...
const brewAudio = new Audio(
  "https://actions.google.com/sounds/v1/water/boiling_water.ogg",
);
brewAudio.loop = true;
brewAudio.volume = 0.3;

const steamAudio = new Audio(
  "https://actions.google.com/sounds/v1/water/air_release.ogg",
);
...
export default function CoffeeBrewerUI({ active }) {
  ...
  // Fluid UI Scaling — uses ResizeObserver for accurate fit
  useEffect(() => {
    const measure = () => {
      const el = containerRef.current;
      if (!el) return;
      const availableHeight = el.clientHeight || window.innerHeight * 0.8;
      const availableWidth  = el.clientWidth  || window.innerWidth;
      // Machine base size: 450 × 850
      const isDesktop = window.innerWidth >= 768;
      // Looser headroom on desktop so the machine actually fills the area
      // without any pixel being clipped (mobile keeps the original safe scale).
      const headroom = isDesktop ? 0.94 : 0.96;
      const scaleH = availableHeight / 870;
      const scaleW = availableWidth  / 460;
      const finalScale = Math.min(scaleH, scaleW) * headroom;
      setScale(Math.max(0.18, finalScale));
    };
  ...
  useEffect(() => {
    ...
    if (power) {
      interval = setInterval(() => {
        setTemp((prev) => {
          if (prev < 93.5)
            return +(prev + 0.5 + Math.random() * 0.5).toFixed(1);
      ...
      >
        ...
        >
          ...
          <div
            style={{
              ...
              height: "100%",
              background:
                "linear-gradient(to right, rgba(255,255,255,0.02), rgba(255,255,255,0.1))",
          ...
          >
            <div
              style={{
                ...
                width: "100%",
                height: `${beanLevel}%`,
                background: "linear-gradient(to top, #3b1c0a, #743e1d)",
            ...
            >
              <div
                style={{
                  ...
                  opacity: 0.5,
                  backgroundImage:
                    "radial-gradient(#1a0f07 2px, transparent 2px)",
        ...
        <div
          style={{
            ...
            boxShadow:
              "0 20px 50px rgba(0,0,0,0.8), inset 0 2px 5px rgba(255,255,255,0.1)",
            padding: "25px",
            display: "flex",
            flexDirection: "column",
            gap: "20px",
        ...
        >
          ...
          >
            <div>
              ...
              >
                <div
                  style={{ width: 4, height: 16, backgroundColor: "#f97316" }}
                ></div>
                <h2
                  style={{
                    margin: 0,
              ...
              >
                <div
                  style={{
                    ...
                    height: 8,
                    borderRadius: "50%",
                    backgroundColor: power ? "#22c55e" : "#333",
                    boxShadow: power ? `0 0 10px #22c55e` : "none",
                  }}
                ></div>
                <span
                  style={{
                ...
                >
                  {power ? (temp > 92 ? "READY" : "HEATING") : "OFFLINE"}
                </span>
              </div>
            </div>
            ...
            >
              <div
                style={{
                  ...
                  transform: `translate(-50%, -100%) rotate(${Math.min(120, temp * 1.5 - 60)}deg)`,
          ...
          >
            ...
            <TelemetryBox
              label="FLOW.R"
              value={`${brew ? (time * 0.5).toFixed(2) : "0.00"}`}
              highlight={brew}
            />
            <TelemetryBox
              label="TIME"
              value={`0:${time.toFixed(1).padStart(4, "0")}`}
              highlight={brew || pouringMilk}
            />
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <div
              style={{
                ...
                width: 6,
                height: 100,
                background: "linear-gradient(to bottom, #c98242 20%, #ffedd5)",
                boxShadow: "0 0 10px rgba(201,130,66,0.8)",
                opacity: brew ? 1 : 0,
          ...
          <div
            style={{
              ...
              width: 8,
              height: 110,
              background: "linear-gradient(90deg, #666, #ccc, #555)",
              borderRadius: "0 0 4px 4px",
              transformOrigin: "top",
              ...
              {[...Array(8)].map((_, i) => (
                <div
                  ...
                  style={{
                    ...
                    filter: "blur(4px)",
                    animation: steam
                      ? `steamFall ${0.5 + Math.random()}s linear infinite`
                      : "none",
            ...
            >
              ...
              <div
                style={{
                  ...
                  boxShadow: "inset 0 10px 15px rgba(0,0,0,0.1)",
                }}
              >
                {/* Froth indicator */}
                <div
                  style={{
                    width: "100%",
                    height: `${Math.min(100, milkFrothed)}%`,
                    background: "rgba(255,255,255,0.7)",
                    position: "absolute",
                    top: 0,
                    borderBottom: "1px solid #e2e8f0",
                    backgroundImage: `radial-gradient(transparent 50%, rgba(0,0,0,0.05) 100%)`,
            ...
            >
              ...
              <div
                style={{
                  ...
                  width: "100%",
                  height: `${coffeeAmount}%`,
                  background: "linear-gradient(to top, #290f01, #4a2109)",
                  transition: "height 0.2s",
                  zIndex: 1,
                }}
              ></div>
    ...
    >
      <button
        ...
        style={{
          ...
          position: "relative",
          boxShadow: active
            ? "inset 0 5px 15px rgba(0,0,0,0.9), 0 2px 5px rgba(255,255,255,0.1)"
            : "inset 0 1px 1px rgba(255,255,255,0.1), 0 10px 20px rgba(0,0,0,0.9)",
    ...
    >
      ...
      <div
        style={{
          ...
          fontSize: "18px",
          fontWeight: "bold",
          textShadow: highlight ? "0 0 10px rgba(255,255,255,0.4)" : "none",
